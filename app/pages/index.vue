          ...
          <section class="" id="examples">
            ...
            <div class="grid grid-cols-4 gap-20" lt-md="grid-cols-2 gap-12">
              <a
                ...
                class="group relative bg-white/60 rounded-16 p-20 border border-white/40 hover:border-primary-300 hover:shadow-lg transition-all-300 cursor-pointer no-underline"
          ...
          <section class="mb-64" id="faq">
            ...
            <div class="max-w-3xl mx-auto flex flex-col gap-12">
              ...
              <div
                ...
                :key="item.id"
                class="bg-white/60 rounded-10 cursor-pointer group border border-white/40"
              >
                <div
